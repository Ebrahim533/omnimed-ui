    ...
    <section className="py-20 lg:py-28">
      <div className="section-container">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl mb-14">
          <p className="text-primary font-display font-semibold text-sm tracking-wider uppercase mb-3">Principal Care Management</p>
          <h1 className="text-4xl sm:text-5xl font-display font-bold text-foreground mb-6">
            Specialist-Led Care for Complex Patients
          </h1>
