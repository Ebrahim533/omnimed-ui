...
import teamClinical from "@/assets/team-clinical.jpg";
import teamData from "@/assets/team-data.jpg";
...
const teamMembers = [
  { name: "Dr. Sarah Chen", role: "Chief Technology Officer", bio: "15+ years in health informatics and AI-driven care platforms.", img: teamCto, linkedin: "#" },
  { name: "Marcus Rivera", role: "VP of Operations", bio: "Scaled care management for 200+ provider networks nationwide.", img: teamOps, linkedin: "#" },
  { name: "Dr. Elena Vasquez", role: "Chief Clinical Officer", bio: "Board-certified internist specializing in chronic disease management.", img: teamClinical, linkedin: "#" },
  { name: "Arjun Patel", role: "Head of Data Science", bio: "Former Google Health — building predictive models for proactive care.", img: teamData, linkedin: "#" },
];
...
const SignatureDraw = () => {
  ...
  return (
    ...
    >
      <img src={ceoSignature} alt="Dr. James Mitchell's signature" className="h-12 w-auto" loading="lazy" />
    </motion.div>
  );
};
        ...
        >
          <div className="grid md:grid-cols-5 gap-0">
            <div className="md:col-span-2">
              <img src={ceoPortrait} alt="Dr. James Mitchell, CEO & Founder" className="w-full h-full object-cover aspect-square md:aspect-auto" loading="lazy" />
            </div>
            <div className="md:col-span-3 p-8 lg:p-12 flex flex-col justify-center space-y-5">
              <p className="text-primary font-display font-semibold text-sm tracking-wider uppercase">Founder & CEO</p>
              <h3 className="text-2xl lg:text-3xl font-display font-bold text-foreground">Dr. James Mitchell</h3>
              ...
              <div className="flex items-center gap-4 pt-2">
                <SignatureDraw />
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-primary/10 flex items-center justify-center hover:bg-primary/20 transition-colors" aria-label="LinkedIn">
            ...
            >
              <div className="aspect-[3/4] overflow-hidden">
                ...
                <div className="absolute inset-0 bg-foreground/70 opacity-0 group-hover:opacity-100 transition-opacity duration-400 flex flex-col justify-end p-6">
                  ...
                  <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-background/20 flex items-center justify-center hover:bg-background/30 transition-colors" aria-label={`${member.name}'s LinkedIn`}>
